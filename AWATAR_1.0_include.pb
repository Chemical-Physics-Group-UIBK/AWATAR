...
Procedure Open_Window_0()
  If OpenWindow(#Window_0, 70, 20, 1058, 632, "AWATAR 1.0 (c) 2006, 2008, 2010, 2021, 2022, 2023, 2024, 2025, 2026 Martin K. Beyer, Magdalena Salzburger, Milan Ončák",  #PB_Window_SystemMenu | #PB_Window_MinimizeGadget | #PB_Window_MaximizeGadget | #PB_Window_SizeGadget | #PB_Window_TitleBar )
...
;      If CreateGadgetList(WindowID(#Window_0))
        ...
        ButtonGadget(#Button_15, 930, 60, 120, 40, "About")
...
;          EditorGadget(#Editor_2, -2, -2, 900, 470)        
        ...
        AddGadgetItem(#Editor_1, -1,"     Print lines where results are zero (YES/NO):           YES   ; option for RRKM Rate Constants and SoS")
        AddGadgetItem(#Editor_1, -1,"")
        ...
        AddGadgetItem(#Editor_1, -1,"")
        AddGadgetItem(#Editor_1, -1,"")        
;        AddGadgetItem(#Editor_1, -1,";Including Transition States between Well-Groups:                          (Isomerisation within a group is barrierless, Isomerisation between groups is not possible below the lowest Isochan-TS, barrierless if isomerisation rates trough TS would be very high (*), only possible via TS otherwise.")
;        AddGadgetItem(#Editor_1, -1,";  Definition of groups: (Default = all wells in group 0)                  !!!code works only with up to 2 groups.!!!)")
;        AddGadgetItem(#Editor_1, -1,";    Group 1: Well 1, Well 3, Well 5                            ; Example for group definition - WARNING: only group 0 wells are included in initial thermal population")
...
; CursorPosition = 27
; Folding = -
; Executable = ..\..\Paper in Progress\Awatar_PCCP_Tutorial\AWATAR_Manual\AWATAR_1.0d.exe